package dk.slott.super_volley.util;
...
public class SystemUiHiderHoneycomb extends SystemUiHiderBase {
	...
	private View.OnSystemUiVisibilityChangeListener mSystemUiVisibilityChangeListener = new View.OnSystemUiVisibilityChangeListener() {
		...
		public void onSystemUiVisibilityChange(int vis) {
			// MSH: Hockeyapp reports null pointer exceptions - so better handle it!
			if(mActivity == null || (Build.VERSION.SDK_INT <= Build.VERSION_CODES.HONEYCOMB_MR2 && Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB))
				return;
